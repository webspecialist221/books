        ...
        <form name="book_form" class="validate_form" enctype="multipart/form-data" action="book-process.php" method="post" >
          <div class="form">
            ...
            <?php } ?>
              ...
              <div class="form_row" id="book_free_block">
                <label for="book_free">Orignal Price</label>
                <!-- <input type="checkbox" id="book_free" name="book_free" value="1" <?php if(isset($book['orginal_price']) && $book['orginal_price'] == 1) echo "checked='checked'"; ?> onclick="validate_book();" /> -->
                <input type="text" class="form_input" name="book_free" value="<?php if(isset($book['orginal_price'])) echo $book['orginal_price']; ?>" required="required" />
              </div>
              <div class="form_row">
                <label for="book_free_sake">Sale Price</label>
                <input type="text" class="form_input" name="book_sale" value="<?php if(isset($book['sale_price'])) echo $book['sale_price']; ?>" required="required" />
              </div>
              <div class="form_row">
...
<script type="text/javascript">
  ...
  function validate_book() {
    if($("#book_free").is(':checked')) {
      ...
      $("#book_ebook").remove();
      var block = "<div class='form_row' id='book_price_block'><label for='book_price'>Book Price</label><input type='text' class='form_input' name='book_price' value='<?php if(isset($book['orginal_price'])) echo $book['orginal_price']; ?>' required='required' /></div>";
      $("#book_free_block").after(block);
    }
  }*/
</script>
