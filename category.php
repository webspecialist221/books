			...
			<div id="main">
				...
				<div id="content">
					...
					<div class="products">
						...
						<div class="row">
							<?php if(isset($category['books']) && sizeof($category['books']) > 0) { ?>
								<?php foreach($category['books'] as $key => $book) { ?>
									<?php
										if($key != 0 && $key % 3 == 0) {
									...
									<div class="product-holder">
										<div class="product">
											...
											<div class="desc">
												...
												<p class="price"><span class="dollar">PKR:&nbsp</span><?php echo $book['book_price']; ?></p>
											</div>
								...
								<?php } ?>
							<?php } else { ?>
								<p>No Books Added to this Category</p>
							<?php } ?>
						</div>
						<div class="cl"></div>
					</div>
