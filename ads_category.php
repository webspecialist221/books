...
<?php 
	$id = $_GET['category_id'] * 1;
	$query1 = mysqli_query($conn,"select * from `categories` where `category_id`='$id'");
	...
	<div class="shell">
		<?php require_once("template/header.php"); ?>
			...
			<div id="main">
				...
				<?php //$category = get_category($_GET['category_id'] * 1); ?>
				<!-- Content -->
				<div id="content">
					<!-- Products -->
					<div class="products">
						...
						<div class="row">
							<?php 
								$query = mysqli_query($conn,"select * from `ads` where `book_category_id`='$id'");
							 ?>
									...
									<div class="product-holder">
										<div class="product">
											...
											<div class="desc">
												...
												<p class="price"><span class="dollar">PKR:&nbsp</span><?php echo $book['orginal_price']; ?></p>
											</div>
